...
public class AmountSpinner extends ArrayAdapter<MyStore> {
    private Context context;
    private ArrayList<MyStore> issueList;

    public AmountSpinner(@NonNull Context context, @LayoutRes int resource, ArrayList<MyStore> issueList) {
